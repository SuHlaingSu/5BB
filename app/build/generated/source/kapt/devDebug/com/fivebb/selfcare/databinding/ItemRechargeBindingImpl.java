...
public class ItemRechargeBindingImpl extends ItemRechargeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.imgTags, 1);
        sViewsWithIds.put(R.id.lblGB, 2);
        sViewsWithIds.put(R.id.lblRechargePack, 3);
        sViewsWithIds.put(R.id.lblDays, 4);
        sViewsWithIds.put(R.id.lblPrice, 5);
    }
    // views
    @NonNull
