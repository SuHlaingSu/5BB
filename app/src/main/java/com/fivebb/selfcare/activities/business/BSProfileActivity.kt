...
import com.fivebb.selfcare.activities.ChangePasswordActivity
import com.fivebb.selfcare.activities.LoginActivity
import com.fivebb.selfcare.activities.PaymentHistoryActivity
...
class BSProfileActivity : BaseActivity(), ProfileView {
    ...
    companion object {
        fun newIntent(context: Context): Intent {
            return Intent(context, BSProfileActivity::class.java)
        }
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.bs_activity_profile)
