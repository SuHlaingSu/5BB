...
class BSHomeActivity : ApplicationBaseActivity(),PXPlanChangeActionDelegate,PlanChangeActionDelegate,
...
//        }
    ...
    override fun saveAdvPay(paymentVO: AdvancePaymentVO) {
        ...
        SharedPreferenceUtils.saveCategory(applicationContext,paymentVO.info.category )
    }
    ...
    companion object {
        ...
        fun newIntent(context: Context, serviceType: String): Intent {
            val intent = Intent(context, BSHomeActivity::class.java)
