...
class LatestPaymentDownloadPDFActivity : BaseActivity(){
    ...
    companion object {
        ...
        fun newIntent(context: Context, url : String): Intent {
          val intent =   Intent(context, LatestPaymentDownloadPDFActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.latest_payment_aty_download)
       ...
       // webView.settings.javaScriptCanOpenWindowsAutomatically = true
        ...
        /*webView.setDownloadListener { url, userAgent, contentDisposition, mimeType, contentLength ->
            ...
            request.setDestinationInExternalFilesDir(
                this@LatestPaymentDownloadPDFActivity,
