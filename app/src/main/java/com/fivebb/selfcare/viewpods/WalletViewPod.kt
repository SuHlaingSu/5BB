...
import kotlinx.android.synthetic.main.viewpod_plan_change.view.tvPlanType
import kotlinx.android.synthetic.main.viewpod_wallet.view.*

class WalletViewPod @JvmOverloads constructor(
    ...
    companion object {
        ...
        fun newInstance(view: View, delegate: PlanChangeActionDelegate) : WalletViewPod {
            val viewPod = view as WalletViewPod
            mDelegate = delegate
